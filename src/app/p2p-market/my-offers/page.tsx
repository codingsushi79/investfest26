        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6 animate-in fade-in-0 slide-in-from-bottom-4 duration-500" style={{ animationDelay: '200ms' }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">{pendingOffers.length}</div>
                <div className="text-sm text-zinc-600 dark:text-zinc-400">Pending Offers</div>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6 animate-in fade-in-0 slide-in-from-bottom-4 duration-500" style={{ animationDelay: '300ms' }}>
            <div className="flex items-center gap-3">
              <div className="text-2xl">✅</div>
              <div>
                <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">{acceptedOffers.length}</div>
                <div className="text-sm text-zinc-600 dark:text-zinc-400">Accepted Offers</div>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6 animate-in fade-in-0 slide-in-from-bottom-4 duration-500" style={{ animationDelay: '400ms' }}>
            <div className="flex items-center gap-3">
              <div className="text-2xl">❌</div>
              <div>
                <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">{declinedOffers.length}</div>
                <div className="text-sm text-zinc-600 dark:text-zinc-400">Declined Offers</div>
              </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex justify-between">
                        <span className="text-zinc-600 dark:text-zinc-400">Your offer:</span>
                        <span className="font-medium">{formatCurrency(offer.offeredPrice)} per share</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-zinc-600 dark:text-zinc-400">Total:</span>
                        <span className="font-bold text-zinc-900 dark:text-zinc-100">{formatCurrency(offer.totalValue)}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        <span className="text-zinc-600 dark:text-zinc-400">Listed at:</span>
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-zinc-200 dark:divide-zinc-700">
                      {acceptedOffers.map((offer) => (
                        <tr key={offer.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-700">
