...
export default function PortfoliosPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-8">
      ...
      {/* Search Bar */}
      <div className="bg-white dark:bg-slate-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-4 shadow-sm">
        ...
        {filteredPortfolios.length === 0 ? (
          ...
          filteredPortfolios.map((p) => {
            ...
            return (
              <div
                key={p.userId}
                className="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-slate-800 p-4 shadow-sm"
              >
                <div className="flex items-center justify-between">
                  <div>
