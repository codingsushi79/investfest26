...
export default function TradePage() {
  ...
  const handleTrade = async (e: React.FormEvent) => {
    ...
    if (!selectedCompany || !shares || !user) {
      setError("Please select a company and enter number of shares");
      return;
    }
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-6">Trade Shares</h2>
            ...
            <form onSubmit={handleTrade} className="space-y-6">
                ...
                <div className={`rounded-lg p-4 ${
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="font-semibold">
                      {shares} shares of {selectedCompany}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-600">
                      Price per share: ${selectedCompanyData.price.toFixed(2)}
                    </span>
                    <span className={`font-bold text-lg ${
                      tradeType === "buy" ? "text-green-600" : "text-red-600"
                    }`}>
                      Total: ${(selectedCompanyData.price * parseInt(shares || "0")).toFixed(2)}
                    </span>
                  </div>
              ...
              <button
                type="submit"
                disabled={trading || !selectedCompany || !shares}
